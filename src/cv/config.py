...
CV_MODEL_PITCH = os.getenv("CV_MODEL_PITCH", "martinjolif/yolo-football-pitch-detection")
...
CV_MIN_FRAMES = int(os.getenv("CV_MIN_FRAMES", "10"))
CV_PX_PER_METER = float(os.getenv("CV_PX_PER_METER", "15.0"))
CV_ENABLE_OCR = os.getenv("CV_ENABLE_OCR", "1") == "1"
